...
public class CustomGrupListeAdapter extends BaseAdapter {
    ...
    public CustomGrupListeAdapter(YeniGrup yeniGrup, ArrayList<String> idler, ArrayList<String> isimler, ArrayList<String> kampusler, ArrayList<String> gorevler,ArrayList<String> resimler)
    {
        ...
        layoutInflater = LayoutInflater.from(yeniGrup.getApplicationContext());
    }
